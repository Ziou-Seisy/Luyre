...
常规的编程范式包括：命令式编程、声明式编程（函数式编程（FP）等）、面向对象编程（OOP）、面向切面编程（AOP）、反应式编程、范型编程、并发编程。
...
Common programming paradigms include: imperative programming, declarative programming (like functional programming), object-oriented programming, aspect-oriented programming, reactive programming, generic programming, and concurrent programming.
